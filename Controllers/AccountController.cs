...
using CityTapsBillingSync.Models.ViewModel;
using CityTapsBillingSync.SD;
...
namespace CityTapsBillingSync.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(SD.SD.Admin).GetAwaiter().GetResult())
            {
                await _roleManager.CreateAsync(new IdentityRole(SD.SD.Admin));
                await _roleManager.CreateAsync(new IdentityRole(SD.SD.User));
            }
            ...
            string returnurl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    await _userManager.AddToRoleAsync(user, SD.SD.User);
